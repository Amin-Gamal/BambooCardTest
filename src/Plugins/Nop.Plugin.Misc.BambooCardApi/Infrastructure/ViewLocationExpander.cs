...
namespace Nop.Plugin.Misc.BambooCardApi.Infrastructure
{
    public class ViewLocationExpander : IViewLocationExpander
    {
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            ...
            {
                viewLocations = new[] { $"/Plugins/Nop.Plugin.Misc.BambooCardApi/Areas/Admin/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
            }
            else
            {
                viewLocations = new[] { $"/Plugins/Nop.Plugin.Misc.BambooCardApi/Views/{context.ControllerName}/{context.ViewName}.cshtml" }.Concat(viewLocations);
            }

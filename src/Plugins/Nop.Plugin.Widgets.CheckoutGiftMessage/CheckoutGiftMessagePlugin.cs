...
namespace Nop.Plugin.Widgets.CheckoutGiftMessage
{
    public class CheckoutGiftMessagePlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _settingService.SetSettingAsync("BambooCard-GiftMessage-CheckoutAttribute-Id", giftMessageCheckoutAttribute.Id);
        ...
        {
            int giftMessageCheckoutAttributeId = await _settingService.GetSettingByKeyAsync<int>("BambooCard-GiftMessage-CheckoutAttribute-Id");
